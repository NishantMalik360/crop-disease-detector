    ...
    if request.method == 'POST':
        ...
        if file:
            ...
            if confidence < 60.0:
                ...
                google_link = f"https://lens.google.com/upload?url={request.url_root}{filepath}" # Simplistic approach
                return render_template('result.html', disease="Unknown / Not Confident", confidence=confidence, 
                                       img_path=filepath, google_link=google_link)
